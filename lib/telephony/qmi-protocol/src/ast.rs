...
pub fn result_map<'de, D>(deserializer: D) -> Result<HashMap<String, HashMap<String, u16>>, D::Error> where D: Deserializer<'de> {
...
pub fn structure_map<'de, D>(deserializer: D) -> Result<HashMap<String, Structure>, D::Error> where D: Deserializer<'de> {
    let mut map = HashMap::new();
